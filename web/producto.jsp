        ...
        <div class="wrapper">
            ...
            <div class="main_content">
                ...
                <div class="info">
                    ...
                    <div class="container">
                        <a href="addProducto.jsp" class="btn btn-success" style="background-color: #46b8da; border: #46b8da">
                                ...
                                <tbody>
                                    <c:forEach var="p" items="${productos}">
                                        <tr class="text-center">
                                            <td>${p.id}</td>
                                            <td>${p.nombre}</td>
                                            <td><img src="${p.ruta}" height="160" width="180"></td>
                                            <td>${p.descripcion}</td>
                                            <td>${p.codigo}</td>
                                            <td>${p.marca}</td>
                                            ...
                                            <td>
                                                ...
                                                <a id="btnDelete" href="<c:url value="Controlador">
                                                       ...
                                                       <c:param name="cod" value="${p.id}" />
                                                        ...
                                                        <input type="hidden" id="codigo" value="${p.id}">
                                                        <a id="btnEditar" href="editProducto.jsp?id=${p.id}&nombre=${p.nombre}&descripcion=${p.descripcion}&codigo=${p.codigo}&marca=${p.marca}">                                                       
